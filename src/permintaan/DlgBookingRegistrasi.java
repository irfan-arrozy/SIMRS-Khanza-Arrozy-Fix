        ...
        try {
            ...
            for(i=0;i<tabMode.getRowCount();i++){  
                try {
                    ...
                    htmlContent.append(
                        "\" "+nohp+"\";\""+"Kami dari RSUD Ar Rozy mengingatkan kembali kepada Bpk./Ibu/Sdr./i "+tabMode.getValueAt(i,4)+" dengan No. RM "+tabMode.getValueAt(i,3)+", bahwa Anda direncanakan kontrol kembali pada tanggal "+tabMode.getValueAt(i,5)+" ke "+tabMode.getValueAt(i,9)+". Kami harap Anda datang sesuai tanggal rencana kontrol tersebut. Bagi Pasien BPJS Kesehatan dapat memanfaatkan Aplikasi Mobile JKN untuk mengambil nomor antrian. Jika Anda ingin merubah rencana kontrol Anda dapat menghubungi nomor WA ini 1 hari sebelum rencana kontrol. Follow dan pantau terus kabar terbaru kami di Instagram @rsudarrozy. Jika Anda membutuhkan bantuan Hubungi Custmer Service di No. WA  081131196002 atau Hotline Pelayanan Rawat Jalan di No. WA 081130756662. Salam Sehat dari "+akses.getnamars()+"\"\n"
                    );
                } catch (Exception e) {
                }
            }                   
