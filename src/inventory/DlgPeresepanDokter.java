...
public final class DlgPeresepanDokter extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        TPasien.setBounds(243, 12, 440, 23);
        ...
        KdDokter.setBounds(105, 72, 90, 23);
        ...
        jLabel13.setBounds(0, 72, 100, 23);
        ...
        DTPBeri.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "04-11-2024" }));
        ...
        jLabel12.setBounds(940, 10, 20, 23);
...
private void ppBersihkanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppBersihkanActionPerformed
    ...
    */
    ...
    public void setNoRm(String norwt,Date tanggal, String jam,String menit,String detik,String KodeDokter,String NamaDokter,String status) {        
        TNoRw.setText(norwt);
        Sequel.cariIsi("select concat(pasien.no_rkm_medis,' / ',pasien.nm_pasien,' (',pasien.umur,') ( J.Kel : ',pasien.jk,' )') from reg_periksa "+
                "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
         
                "where no_rawat=? ",TPasien,TNoRw.getText());
