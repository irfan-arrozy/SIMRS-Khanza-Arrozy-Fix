 ...
 * @author perpustakaan
 */
public final class RMDataCatatanObservasiRanapNeonatus extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMDataCatatanObservasiRanapNeonatus(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
