...
public final class DlgCariObat2 extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        DTPTgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "31-10-2024" }));
        ...
        label12.setBounds(370, 10, 50, 23);
        ...
        Jeniskelas.setBounds(420, 10, 80, 23);
        ...
        ChkNoResep.setBounds(510, 10, 80, 23);
...
private void ChkJlnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkJlnActionPerformed
    ...
    */
    ...
    public void setNoRm(String norwt,String norm,String pasien,String umur,String ruang,String jk,String bb,Date tanggal,String jam,String menit,String detik,boolean status) {        
        aktifpcare="no";
        TNoRw.setText(norwt);
        TNoRM.setText(norm);
        TPasien.setText(pasien);
        DTPTgl.setDate(tanggal);
        TUmur.setText(Sequel.cariIsi("select reg_periksa.umurdaftar from reg_periksa where reg_periksa.no_rawat=?",norwt));
        TRuang.setText(Sequel.cariIsi("select poliklinik.nm_poli from reg_periksa inner join poliklinik on reg_periksa.kd_poli=poliklinik.kd_poli where reg_periksa.no_rawat=?",norwt));
        TJk.setText(Sequel.cariIsi("select pasien.jk from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis where reg_periksa.no_rawat=?",norwt));       
        TBb.setText(Sequel.cariIsi("select pemeriksaan_ralan.berat from reg_periksa inner join pemeriksaan_ralan on reg_periksa.no_rawat=pemeriksaan_ralan.no_rawat where reg_periksa.no_rawat=?",norwt));
    ...
    public void setNoRm(String norwt,String norm,String pasien,String umur,String ruang,String jk,String bb,Date tanggal) {       
        aktifpcare="no";
        TNoRw.setText(norwt);
        TNoRM.setText(norm);
        TPasien.setText(pasien);
