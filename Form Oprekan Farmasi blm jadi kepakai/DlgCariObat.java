...
private void JeniskelasKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_JeniskelasKeyPressed
    ...
    */
    ...
    public void setNoRm(String norwt,String norm,String nama,String tanggal,String jam,String umur,String ruang,String jk,String bb) {        
        aktifpcare="no";
        TNoRw.setText(norwt);
        ...
        Jam.setText(jam);  
        KdPj.setText(Sequel.cariIsi("select reg_periksa.umurdaftar from reg_periksa where reg_periksa.no_rawat=?",norwt));
    ...
    public void setNoRm2(String norwt,String norm,String nama,String umur,String ruang,String jk,String bb, Date tanggal, String jam,String menit,String detik,boolean cekbox) {        
        aktifpcare="no";
        TNoRw.setText(norwt);
        LblNoRawat.setText(norwt);
        TNoRM.setText(norm);
